            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="office" class="col-md-4 col-form-label text-md-end">Кабинет</label>
                            <div class="col-md-6">
                                <select id="office" class="form-select @error('office') is-invalid @enderror" name="office_id" required >
                        ...
                        <div class="row mb-3">
                            <label for="post" class="col-md-4 col-form-label text-md-end">Должность</label>
                            <div class="col-md-6">
                                <select id="post" class="form-select @error('post') is-invalid @enderror" name="post_id" required >
